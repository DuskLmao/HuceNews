       ...
       @include('layout.header')
        ...
        <div class="container mt-5 mb-2 pt-4">
            <div class="link__title">
                ...
                @if(isset($is_subcategory))
                    @if($is_subcategory)
                        <!-- Trường hợp là subcategory -->
                        <span class="link__title-icon"><i class="fas fa-chevron-right"></i></span>
                        <span class="link__title-link"><a href="/category/{{ $parent_category->id }}_{{ $parent_category->sort_name }}.html">{{ $name }}</a></span>
                        
                        <span class="link__title-icon"><i class="fas fa-chevron-right"></i></span>
                        <span class="link__title-link">{{ $title }}</span>
                    @else
                        <!-- Trường hợp là category -->
                        <span class="link__title-icon"><i class="fas fa-chevron-right"></i></span>
